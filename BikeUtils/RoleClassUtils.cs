...
public static class RoleClassUtils
{
    ...
    {
        var colorRoleServer = player.ReferenceHub.serverRoles.MyColor;
        if (colorRoleServer == "default") colorRoleServer = "#FFFFFF";
        return colorRoleServer;
    }

    /// <summary>
    /// Translates a <see cref="RoleTypeId"/> into the Brazillian Portuguese name of role.
    /// </summary>
